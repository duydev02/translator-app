...
def show_help_dialog(app):
    ...
    content = (
        ...
        "  Ctrl+Shift+B         Open Schema Browser scoped to input names\n"
        "  Ctrl+J               Open Snippets\n"
        "  Ctrl/Cmd+P           Command palette\n"
        "\n"
        "──  TOOLS  ──\n"
        "  Ctrl+Shift+L         🛠 Extract SQL from log…\n"
        "                       Browse every prepared statement in a\n"
        "                       stclibApp.log; primary business queries\n"
        "                       surfaced above infrastructure noise.\n"
        "                       Result tab (first) shows the SQL with ?s\n"
        "                       filled in, prettified, syntax-highlighted,\n"
        "                       with bound values called out.\n"
        "                       'Send to translator input' pipes the\n"
        "                       filled SQL straight into the active tab.\n"
        "\n"
        "──  EDITING  ──\n"
